...
use cosmwasm_std::{to_binary, Binary, Deps, DepsMut, Env, MessageInfo, Response, StdResult, CosmosMsg, Coin, Uint128, attr, WasmMsg};
...
pub fn execute(
    ...
    match msg {
        ExecuteMsg::CosmWasmSwap {} => try_cosmwasm_swap(deps),
    }
}

pub fn try_cosmwasm_swap(deps: DepsMut) -> Result<Response<TerraMsgWrapper>, ContractError> {
